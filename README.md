...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="theme--agnostic" fill="none" width="1000" height="330">
		...
		<svg class="guage-div guage-perf guage-green" viewBox="0 0 200 200" width="200" height="200" x="0" y="0">
			...
			<circle class="gauge-arc guage-arc-1" r="56" cx="100" cy="60" stroke-width="8" style="stroke-dasharray: 327.22794, 351.858;"/>
			<text class="guage-text" x="100px" y="60px" alignment-baseline="central" dominant-baseline="central" text-anchor="middle">93</text>
		...
		<svg class="guage-div guage-acc guage-green" viewBox="0 0 200 200" width="200" height="200" x="200" y="0">
			<circle class="gauge-base" r="56" cx="100" cy="60" stroke-width="8"/>
			<circle class="gauge-arc guage-arc-2" r="56" cx="100" cy="60" stroke-width="8" style="stroke-dasharray: 340.22794, 351.858;"/>
		...
		<svg class="guage-div guage-pwa " viewBox="0 0 200 200" width="200" height="200" x="800" y="0">
			<svg viewBox="0 0 60 60" width="112" height="112" x="44" y="4">
				...
				<g stroke="none" fill-rule="nonzero">
					...
					<!-- No badges. -->
					<rect class="lh-gauge--pwa__component lh-gauge--pwa__na-line lh-gauge--pwa__invisible" fill="#FFFFFF" x="20" y="32" width="20" height="4" rx="2"/>
